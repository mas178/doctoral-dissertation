...
We conducted computational experiments to investigate how the EV ($p_{EV}$) and the agent mobility ($p_M$) affect the cooperation rates at both the group ($\phi_C^R$) and agent levels ($\phi_C^F$).
...
\textcolor{red}{
ToDo: The evolution of agent-level cooperation by EV can be explained by ...
}
