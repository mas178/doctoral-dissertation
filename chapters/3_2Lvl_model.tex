...
\begin{figure}[!ht]
  ...
  \caption[Individual level cooperation evolution and resource dynamics]{
Individual level cooperation evolution and resource dynamics.
(a) Cooperation rate at the individual level over time ($\phi_C^F$): when $p_{EV} = 0$, $\phi_C^F$ declines to near zero, while when $p_{EV} = 0.1$, $\phi_C^F$ reaches and maintains high levels.
