...
The evolution of individual level cooperation by EV can be explained by temporal resource fluctuations in a group and relationship formation between cooperators.
...
Since resources are shared equally among individuals within each group, this concentration equalizes per-capita resources across all groups (Figure~\ref{fig:mechanism1_3}a).
In this equilibrium state, defectors outcompete cooperators due to PGG rules: cooperators invest resources while defectors receive resources without contributing (Figure~\ref{fig:mechanism1_3}b).
...
Because migration requires time, disparities in per-capita resources between groups occasionally emerge after each SoR movement (Figure~\ref{fig:mechanism1_3}a).
...
Through this process, cooperators become robust against resource fluctuations and seldom undergo migration and strategy updates, while defectors undergo migration and strategy updates more frequently (Figure~\ref{fig:mechanism1_3}b).

\begin{figure}[!ht]
  \centering
  \includegraphics[width=1.0\textwidth]{figures/3/Mechanism1_3}
  \caption[Individual level resource dynamics]{
Individual level resource dynamics.
(a) Difference between maximum and minimum per-capita resources across groups over time: when $p_{EV} = 0$, the difference converges to zero as resources equalize across groups, while when $p_{EV} > 0$, stochastic SoR movement maintains persistent fluctuations in resource disparities between groups.
(b) Difference in mean per-capita resources between cooperators and defectors over time: when $p_{EV} = 0$, defectors maintain higher resources than cooperators (negative difference), while when $p_{EV} > 0$, cooperators maintain higher resources than defectors (positive difference) through strong mutual relationships.
Other conditions are identical to Figure~\ref{fig:result1_1}.
  }
...
\begin{figure}[H]
  ...
  \caption[Placeholder for Figure~\ref{fig:result2_1}]{Placeholder figure for population size effects ($N
_R$, $N_F$) under varying $p_{EV}$ and $p_M$.}
  \label{fig:result2_1}
\end{figure}
...
At the individual level, $\phi_C^F$ decreases slightly with increasing $N_R$ but increases slightly with increasing $N_F$ (Figure~\ref{fig:result2_1}f).
...
\begin{figure}[H]
  \centering
  \fbox{\rule{0pt}{2in} \rule{0.9\textwidth}{0pt}}
  \caption[Placeholder for Figure~\ref{fig:result2_2}]{Placeholder figure for effects of initial cooperation rate $\phi_C^0$.}
  \label{fig:result2_2}
\end{figure}
