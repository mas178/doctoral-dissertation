...
The left panels (a,c,e,g) show the group level cooperation rates $\phi_C^R$, and the right panels (b,d,f,h) show the individual level cooperation rates $\phi_C^F$.
