...
As the principal performance indicators, we calculate the cooperation rates $\phi_R^C$ and $\phi_F^C$, defined as the average proportions of groups and individuals, respectively, employing strategy $C$.
Specifically, $\phi_R^C$ is the mean of the proportions of the $N_R$ groups employing strategy $C$ at the end of each generation (following the strategy update stage), averaged over the last $5000$ generations and $100$ independent runs.
$\phi_F^C$ is calculated in the same manner, using the proportions of the $N_F$ individuals employing strategy $C$.
