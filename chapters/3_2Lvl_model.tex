...
\textcolor{red}{
NOTE: This chapter is based on an ongoing manuscript.
The Model section is approximately 80\% complete, and the Results section is approximately 50\% complete.
Both sections will be finalized and integrated into the dissertation structure.
}
