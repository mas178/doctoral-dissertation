...
Although the one-dimensional spatial structure is used for simplicity, more realistic structures can be explored as empirical studies progress.
...
The average cooperation rate is calculated as the mean of cooperation rates averaged over both the last $5,000$ generations and the $100$ independent trials.
...
The results show that RV strongly promotes cooperation, UV has a marginal effect, and CV reflects the additive effects of both RV and UV.This difference arises from two key factors: the fluctuations in strategy distribution generated by EV, and the coevolution of cooperation and network structure.
