...
In this chapter\protect\footnote{This chapter is based on Inaba and Akiyama (2025) \cite{Inaba2025b}, published in \textit{Chaos, solitons \& fractals}.} we adopt a 2-dimensional (2D) space without explicit group structures, which is widely used in the literature.
...
To investigate the effects of environmental variability and agent mobility on the evolution of cooperation, simulations are performed under a range of parameter configurations, as shown in Table~\ref{tab:4_params}.
...
$N$ & Number of agents & $500 \times 2^{\{0, 1, 2, 3, 4, 5\}}$ \\
...
in Chapter~\ref{ch:2_base_model}, the intensity of EV is controlled by $\sigma_R$ (shift range of the SoR)

the intensity of EV is controlled by $\sigma_R$ (shift range of the SoR) in Chapter~\ref{ch:2_base_model}.
...
The next chapter, Chapter~\ref{ch:5_conclusion}, synthesizes and compares the findings from all three models to identify common mechanisms and discuss the broader implications for understanding the evolution of cooperation under environmental variability.