...
To isolate the fundamental mechanisms by which EV promotes cooperation, we employed several abstractions in each model component: spatial structure, population structure, EV, interaction, migration, and strategy update.

Regarding the spatial structure, regular topologies, specifically 1-dimensional cycle graphs and 2-dimensional lattices, were employed.
...
Potential avenues for extending this work include the adoption of more complex network architectures or the integration of spatially explicit models grounded in paleoenvironmental reconstructions of the MSA in Africa.

Regarding the population structure, the models employed either non-hierarchical structures (homogeneous group- or individual-level agents) or a minimal 2-level hierarchical structure.
Although real-world human social structures exhibit complex fractal organizations, restricting the model to simple structures represents a standard methodological approach.
...
Regarding the interaction, the models adopted a fundamental pairwise game framework restricted to binary strategies of unconditional cooperation or defection.
...
Regarding the migration, the process was triggered by resource scarcity and migration probability, assuming zero migration costs.
However, human mobility decisions in the real world are influenced by social factors and other environmental factors.
Future models could thus incorporate migration costs and more realistic migration dynamics, for example by accounting for conflict avoidance, mate-seeking, kinship obligations, and predator avoidance.

Regarding the strategy update, the process has been extensively examined within the framework of cultural evolution.
Within this context, learning mechanisms for strategy updating are mainly classified into social learning (SL), individual learning (IL), and their interplay.
The models adopted payoff-biased imitation where agents copy the most successful strategies observed within their communication range.
...
% ToDo: The unit of migration, 人口増減, interaction が本当に group 単位でも起こっていたのか、individual 単位でも起こっていたのか。適応の単位はgroupで起こるのか？
