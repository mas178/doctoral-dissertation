...
These studies investigate how factors such as memory constraints, complex network structures, social norms, environmental variability (EV), and learning mechanisms shape the evolution of cooperation.
...
Among these context-specific factors, this dissertation focuses on EV.

\section{Environmental variability and modern human behavior}\label{sec:ev_and_mhb}

Before examining how EV specifically affects cooperation, it is useful to consider a broader theoretical framework concerning the evolution of ``modern human behavior".
In anthropology and archaeology, modern human behavior refers to a suite of traits characteristic of \textit{Homo sapiens}, including abstract thinking, symbolic expression, complex planning, language, art, and crucially, large-scale cooperation and ultrasociality.
...
\section{Environmental variability and evolution of cooperation}\label{sec:ev_and_eoc}
...
\textcolor{red}{[TODO: This paragraph is a temporary template and needs to be filled with actual literature review.]}
A growing body of research has examined the relationship between environmental variability and the evolution of cooperation.
\textcolor{red}{[TODO: Add specific studies from evolutionary biology]}.
\textcolor{red}{[TODO: Add studies from physics/complex systems]}.
\textcolor{red}{[TODO: Add studies from economics/game theory]}.
These studies have demonstrated \textcolor{red}{[TODO: summarize key findings]}.

However, existing studies have primarily focused on \textcolor{red}{[TODO: describe what existing studies examine]}.
In contrast, we hypothesize that \textcolor{red}{[TODO: describe the specific type of EV relevant to MSA]}, characterized by \textcolor{red}{[TODO: specific features]}, may have played a critical role in the evolution of large-scale cooperation during the MSA.
This specific type of EV has not yet been systematically examined in the context of the evolution of cooperation.
